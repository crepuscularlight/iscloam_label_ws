...
class ISCGenerationClass
{
    public:
        ...
        void loopDetection(const pcl::PointCloud<pcl::PointXYZL>::Ptr& current_pc, Eigen::Isometry3d& odom);
    ...
    private:
        ...
        pcl::PointCloud<pcl::PointXYZL>::Ptr current_point_cloud;
        pcl::PointCloud<pcl::PointXYZL>::Ptr test_pc;
        ...
        ISCDescriptor calculate_isc(const pcl::PointCloud<pcl::PointXYZL>::Ptr filtered_pointcloud);
        ...
        void ground_filter(const pcl::PointCloud<pcl::PointXYZL>::Ptr& pc_in, pcl::PointCloud<pcl::PointXYZL>::Ptr& pc_out);
};
